...
import { AnomalyAiAgent } from "@/components/anomalies/anomaly-ai-agent";
  ...
  return (
    <main className="mx-auto w-full max-w-6xl flex-1 px-6 py-12 sm:py-16">
      ...
      <h1 className="mt-2 text-3xl font-semibold tracking-tight text-foreground">
        {meter} <span className="text-foreground-subtle">·</span> {formatDay(day)}
      </h1>
      ...
      <AnomalyAiAgent meter={meter} day={day} />
      ...
      {historyError ? (
        ...
        <>
          <section className="mt-10">
            <h2 className="text-lg font-semibold tracking-tight text-foreground">Consumption vs Expected</h2>
          ...
          <section className="mt-10">
            <h2 className="text-lg font-semibold tracking-tight text-foreground">Meter history</h2>
            <p className="mt-1 text-sm text-foreground-muted">
